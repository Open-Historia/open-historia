...
| Diagnostics | `DiagnosticsPanel` — **📋 Copy log** / **💾 Save as file** / **Clear**, plus a live entry count | `buildDebugLogReport`, `debugLogFilename`, `clearDebugLog` (`src/runtime/debugLog.js`) |
