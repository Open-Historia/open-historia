/*! Open Historia — release-channel stamp. */
// Writes electron/channel.json, which is how the packaged desktop app knows
// whether it is the stable build or the fork's beta. Same pattern as the build id
...
//
//   node scripts/stamp-channel.mjs beta     -> the fork's beta build
