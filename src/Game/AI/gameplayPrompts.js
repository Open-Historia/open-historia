...
- regionClaims: {"regionId":"","regionName":"","claimantCode":"","claimantRole":"","drop":false,"note":""}
- regionControlOps: contest {"op":"contest","regionId":"","fromCode":"","actorCode":"","actorRole":"","note":""}; control {"op":"control","regionId":"","fromCode":"","toCode":"","toRole":"","note":"","wholeCountry":false}; for wholeCountry=true, fromCode MUST be the losing/current controller's full current name and regionId MUST repeat that polity name; clear {"op":"clear_contest","regionId":"","fromCode":"","claimantCode":"","clearAll":false,"note":""}
- polityChanges: {"operation":"update|create|rename|restore|dissolve","code":"","name":"","color":"","aliases":[],"reputation":50,"intelligence":50,"tags":[],"role":"","stats":{},"note":""}; include only fields actually changed except operation/code. For create/restore, code is the stable polity identity; name may be a different current regime/display name only when this event establishes it
...
Canonical Political Actor entity references relevant to this request (exact ids; reuse existing ids instead of inventing replacements):
\${gameMasterPoliticalActorContext}
...
Rendered base-geography catalog (exact names/counts for territorialScopesJson):
