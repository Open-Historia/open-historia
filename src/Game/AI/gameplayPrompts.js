...
- exact-event: Author exactly ONE canonical timeline event. Its prose and every lasting structured effect must agree. The event may also create war/relation/agreement changes, chats, territory changes, Stats changes, units, markers, or polity lifecycle changes when the request says so.
...
8. impacts.markerOps = runtime map-feature build/remove/rename operations. Use real numeric longitude/latitude for builds.
...
16. Narration and state must agree. Never say a border moved, war began/ended, treaty was signed, unit moved, government changed, or structure was created unless the matching structured operation is present.
...
- markerOps: build {"op":"build","marker":{"name":"","kind":"","ownerCode":"","lng":0,"lat":0,"note":"","foundedAt":""}}; remove {"op":"remove","name":"","note":""}; rename {"op":"rename","name":"","newName":"","note":""}
